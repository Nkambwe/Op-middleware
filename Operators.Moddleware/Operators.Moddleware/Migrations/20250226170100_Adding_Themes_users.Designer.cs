...
namespace Operators.Moddleware.Migrations
{
    ...
    [Migration("20250226170100_Adding_Themes_users")]
    partial class Adding_Themes_users
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Operators.Moddleware.Data.Entities.Settings.UserTheme", b =>
                {
                    b.HasOne("Operators.Moddleware.Data.Entities.Access.User", "User")
                        .WithOne("Theme")
                        .HasForeignKey("Operators.Moddleware.Data.Entities.Settings.UserTheme", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
