    ...
    public class MappingProfile : Profile {
        public MappingProfile() {
            ...
            CreateMap<User, UserResponse>()
                ...
                .ForPath(dest => dest.Data.BranchCode, opt => opt.MapFrom(o => o.Branch != null ? o.Branch.Id : 0))
                ...
                .ForPath(dest => dest.Data.RoleId, opt => opt.MapFrom(o => o.Role != null ? o.Role.Id : 0))
